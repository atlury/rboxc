"""Namespace Diffutils helper definitions and Rust-owned diff state together."""
...
HELPER_OBJECTS = ('analyze', 'context', 'dir', 'ed', 'ifdef', 'io', 'normal', 'side', 'system', 'util')
...
def native_inputs(root):
    ...
    return [build/'src/libver.a', build/'lib/libdiffutils.a',
