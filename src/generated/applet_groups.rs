...
// Source SHA-256: 887f7bde9dad22c46d714addd3ef932f048f10e3e6144e25475121172fbc83c7
...
#[no_mangle]
pub unsafe extern "C" fn _usage_groups(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_groups(
        ...
        *__errno_location() = 0 as ::core::ffi::c_int;
        ...
        while optind < argc {
            ...
            if pwd.is_null() {
                ...
                let mut ruid_0: uid_t = (*pwd).pw_uid;
                let mut rgid_0: gid_t = (*pwd).pw_gid;
                let mut egid_0: gid_t = rgid_0;
                printf(
