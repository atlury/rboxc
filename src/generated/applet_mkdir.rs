...
// Source SHA-256: c46ae65c4b25e6124cf8bfd9a2441913ff89d766d99e754498e236ef86500da1
...
#[repr(C)]
pub struct savewd {
    pub state: C2Rust_Unnamed_2,
    pub val: C2Rust_Unnamed_1,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct mkdir_options {
    ...
    pub created_directory_format: *const ::core::ffi::c_char,
}
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 6] =
    unsafe { ::core::mem::transmute::<[u8; 6], [::core::ffi::c_char; 6]>(*b"mkdir\0") };
...
#[no_mangle]
pub unsafe extern "C" fn _usage_mkdir(mut status: ::core::ffi::c_int) {
...
unsafe extern "C" fn make_ancestor(
    ...
    if !(*o).set_security_context.is_null()
        && defaultcon((*o).set_security_context, component, S_IFDIR as mode_t)
            < 0 as ::core::ffi::c_int
    ...
    let mut r: ::core::ffi::c_int = mkdir(component, S_IRWXUGO as __mode_t);
    if (*o).umask_ancestor != (*o).umask_self {
        let mut mkdir_errno: ::core::ffi::c_int = *__errno_location();
        umask((*o).umask_self);
        *__errno_location() = mkdir_errno;
    }
    if r == 0 as ::core::ffi::c_int {
        r = ((*o).umask_ancestor & S_IRUSR as mode_t != 0 as mode_t) as ::core::ffi::c_int;
...
unsafe extern "C" fn process_dir(
    ...
    if !(*o).set_security_context.is_null() {
        if (*o).make_ancestor_function.is_none()
            && defaultcon((*o).set_security_context, dir, S_IFDIR as mode_t)
                < 0 as ::core::ffi::c_int
            && !ignorable_ctx_err(*__errno_location())
        {
            if 0 != 0 {
    ...
    if ret == EXIT_SUCCESS
        && !(*o).set_security_context.is_null()
        && (*o).make_ancestor_function.is_some()
    {
        if !restorecon((*o).set_security_context, last_component(dir), r#false != 0)
            && !ignorable_ctx_err(*__errno_location())
        {
            if 0 != 0 {
                error(
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_mkdir(
    ...
    let mut options: mkdir_options = mkdir_options {
        ...
        created_directory_format: ::core::ptr::null::<::core::ffi::c_char>(),
    };
    options.make_ancestor_function = None;
    options.mode = S_IRWXUGO as mode_t;
    options.mode_bits = 0 as mode_t;
    options.created_directory_format = ::core::ptr::null::<::core::ffi::c_char>();
    options.set_security_context = ::core::ptr::null_mut::<selabel_handle>();
    ...
    loop {
        optc = getopt_long(
            argc,
            argv,
            b"pm:vZ\0".as_ptr() as *const ::core::ffi::c_char,
        ...
        match optc {
            112 => {
                options.make_ancestor_function = Some(
                    make_ancestor
            ...
            118 => {
                options.created_directory_format = dcgettext(
                    ::core::ptr::null::<::core::ffi::c_char>(),
                    b"created directory %s\0".as_ptr() as *const ::core::ffi::c_char,
                    LC_MESSAGES,
                );
            }
            90 => {
    ...
    if options.make_ancestor_function.is_some() || !specified_mode.is_null() {
        ...
        options.umask_ancestor = umask_value & !(S_IWUSR | S_IXUSR) as mode_t;
