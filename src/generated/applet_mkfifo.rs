...
// Source SHA-256: acc263f03283c53e6175bbd5c0c700fea466e87cc267b748af2bd9f4041a0794
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 7] =
    unsafe { ::core::mem::transmute::<[u8; 7], [::core::ffi::c_char; 7]>(*b"mkfifo\0") };
...
#[no_mangle]
pub unsafe extern "C" fn _usage_mkfifo(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_mkfifo(
            ...
            if 0 != 0 {
                error(
                    ...
                    *__errno_location(),
                    dcgettext(
                        ::core::ptr::null::<::core::ffi::c_char>(),
                        b"cannot create fifo %s\0".as_ptr() as *const ::core::ffi::c_char,
                        5 as ::core::ffi::c_int,
                    ),
                    quotearg_style(
                ...
                ({
                    ...
                    error(
                        ...
                        *__errno_location(),
                        dcgettext(
                            ::core::ptr::null::<::core::ffi::c_char>(),
                            b"cannot set permissions of %s\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            5 as ::core::ffi::c_int,
                        ),
                        quotearg_style(
