...
// Source SHA-256: e99b358d018e53047ca2ae6c8e705151c2445f5bf38086b29653bff95c78d6d5
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 9] =
    unsafe { ::core::mem::transmute::<[u8; 9], [::core::ffi::c_char; 9]>(*b"basename\0") };
static mut longopts: [option; 6] = [
    option {
        name: b"multiple\0".as_ptr() as *const ::core::ffi::c_char,
        has_arg: no_argument,
...
#[no_mangle]
pub unsafe extern "C" fn _usage_basename(mut status: ::core::ffi::c_int) {
...
unsafe extern "C" fn remove_suffix(
    ...
    mut suffix_len: idx_t,
) {
    let mut np: *mut ::core::ffi::c_char = name.offset(strlen(name) as isize);
    let mut sp: *const ::core::ffi::c_char = suffix.offset(suffix_len as isize);
    while np > name && sp > suffix {
        np = np.offset(-1);
        sp = sp.offset(-1);
        if *np as ::core::ffi::c_int != *sp as ::core::ffi::c_int {
            return;
        }
    }
    if np > name {
...
unsafe extern "C" fn perform_basename(
    ...
    let mut name: *mut ::core::ffi::c_char = base_name(string);
    strip_trailing_slashes(name);
    if (0 as idx_t) < suffix_len
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_basename(
    mut argc: ::core::ffi::c_int,
    mut argv: *mut *mut ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut multiple_names: bool = r#false != 0;
    ...
    loop {
        let mut c: ::core::ffi::c_int = getopt_long(
            argc,
            argv,
            b"+as:z\0".as_ptr() as *const ::core::ffi::c_char,
        ...
        's_91: {
            match c {
                ...
                _ => {
                    _usage_basename(EXIT_FAILURE);
                    break 's_91;
                }
            }
            multiple_names = r#true != 0;
        }
    }
    ...
    if !multiple_names {
        if optind + 2 as ::core::ffi::c_int == argc {
            suffix = *argv.offset((optind + 1 as ::core::ffi::c_int) as isize);
        } else if (optind + 2 as ::core::ffi::c_int) < argc {
            if 0 != 0 {
                error(
                    0 as ::core::ffi::c_int,
                    0 as ::core::ffi::c_int,
    ...
    let mut suffix_len: idx_t = (if !suffix.is_null() {
        strlen(suffix)
    } else {
        0 as size_t
    }) as idx_t;
    let mut file: *mut *mut ::core::ffi::c_char = argv.offset(optind as isize);
    let mut n_files: ::core::ffi::c_int = if multiple_names as ::core::ffi::c_int != 0 {
        argc - optind
    } else {
        1 as ::core::ffi::c_int
    };
    ...
    while i < n_files {
        perform_basename(*file.offset(i as isize), suffix, suffix_len, use_nuls);
        i += 1;
    }
    return EXIT_SUCCESS;
}
