...
// Source SHA-256: 14656a6c13c57f680eaaa621399eea68e5d0e7e77743fa40c54974a2e2f7ae60
/* GNU's users.
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 6] =
    unsafe { ::core::mem::transmute::<[u8; 6], [::core::ffi::c_char; 6]>(*b"users\0") };
unsafe extern "C" fn userid_compare(
    mut v_a: *const ::core::ffi::c_void,
    mut v_b: *const ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut a: *mut *mut ::core::ffi::c_char = v_a as *mut *mut ::core::ffi::c_char;
    let mut b: *mut *mut ::core::ffi::c_char = v_b as *mut *mut ::core::ffi::c_char;
    return strcmp(*a, *b);
}
unsafe extern "C" fn list_entries_users(mut n: idx_t, mut this: *const STRUCT_UTMP) {
    let mut u: *mut *mut ::core::ffi::c_char = xinmalloc(
        n,
        ::core::mem::size_of::<*mut ::core::ffi::c_char>() as idx_t,
    ) as *mut *mut ::core::ffi::c_char;
    let mut n_entries: idx_t = 0 as idx_t;
    loop {
        let c2rust_fresh5 = n;
        n -= 1;
        if c2rust_fresh5 == 0 {
        ...
        if *(*this).ut_user.offset(0isize) as ::core::ffi::c_int != 0
            && (*this).ut_type as ::core::ffi::c_int == USER_PROCESS
        {
            ...
            *u.offset(n_entries as isize) = trimmed_name;
            n_entries += 1;
        }
        this = this.offset(1);
    }
    ...
    while i < n_entries {
        let mut c: ::core::ffi::c_char = (if i < n_entries - 1 as idx_t {
            ' ' as ::core::ffi::c_int
        } else {
            '\n' as ::core::ffi::c_int
        }) as ::core::ffi::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn _usage_users(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_users(
    ...
    parse_gnu_standard_options_only(
        ...
        Version,
        r#true != 0,
        Some(_usage_users as unsafe extern "C" fn(::core::ffi::c_int) -> ()),
        proper_name_lite(
    ...
    match argc - optind {
        0 => {
            users(
                UTMP_FILE.as_ptr(),
                C2Rust_Unnamed_1::READ_UTMP_CHECK_PIDS.0 as ::core::ffi::c_int,
            );
        }
        1 => {
            users(*argv.offset(optind as isize), 0 as ::core::ffi::c_int);
        }
        _ => {
            if 0 != 0 {
                error(
