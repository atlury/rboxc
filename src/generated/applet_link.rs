...
// Source SHA-256: d7346f694b14bb6efca7ea81f4942fa8564b0b3184017e26280d25ca012cabe2
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 5] =
    unsafe { ::core::mem::transmute::<[u8; 5], [::core::ffi::c_char; 5]>(*b"link\0") };
#[no_mangle]
pub unsafe extern "C" fn _usage_link(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_link(
    ...
    parse_gnu_standard_options_only(
        ...
        Version,
        r#true != 0,
        Some(_usage_link as unsafe extern "C" fn(::core::ffi::c_int) -> ()),
        proper_name_lite(
        ...
        if 0 != 0 {
            error(
                ...
                *__errno_location(),
                dcgettext(
                    ::core::ptr::null::<::core::ffi::c_char>(),
                    b"cannot create link %s to %s\0".as_ptr() as *const ::core::ffi::c_char,
                    5 as ::core::ffi::c_int,
                ),
                quotearg_n_style(
                    0 as ::core::ffi::c_int,
