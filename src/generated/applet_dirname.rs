...
// Source SHA-256: 67377499d911a831b6bfbe2252c97b7b0bbcefdd93a4d0caa61c0d575213cdc0
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 8] =
    unsafe { ::core::mem::transmute::<[u8; 8], [::core::ffi::c_char; 8]>(*b"dirname\0") };
...
#[no_mangle]
pub unsafe extern "C" fn _usage_dirname(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_dirname(
    ...
    while optind < argc {
        let mut result: *const ::core::ffi::c_char = *argv.offset(optind as isize);
        let mut len: idx_t = dir_len(result) as idx_t;
        if len == 0 {
            static mut dot: ::core::ffi::c_char = '.' as ::core::ffi::c_char;
            result = &raw const dot;
            len = 1 as idx_t;
        }
        if 0 != 0
            && 0 != 0
        ...
        {
            ({
                let mut __ptr: *const ::core::ffi::c_char = result;
                let mut __stream: *mut FILE = stdout;
                let mut __cnt: size_t = 0;
