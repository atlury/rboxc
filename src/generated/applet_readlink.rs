...
// Source SHA-256: 49e864759e21c8fee42b0114a24eb3599d8e48a4300ed13cec0af3af2285da2f
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 9] =
    unsafe { ::core::mem::transmute::<[u8; 9], [::core::ffi::c_char; 9]>(*b"readlink\0") };
...
static mut longopts: [option; 11] = [
    ...
    option {
        name: b"no-newline\0".as_ptr() as *const ::core::ffi::c_char,
        has_arg: no_argument,
        flag: ::core::ptr::null_mut::<::core::ffi::c_int>(),
...
#[no_mangle]
pub unsafe extern "C" fn _usage_readlink(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_readlink(
    mut argc: ::core::ffi::c_int,
    mut argv: *mut *mut ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut can_mode: ::core::ffi::c_int = -1 as ::core::ffi::c_int;
    let mut status: ::core::ffi::c_int = EXIT_SUCCESS;
    let mut optc: ::core::ffi::c_int = 0;
    let mut use_nuls: bool = r#false != 0;
    ...
    loop {
        optc = getopt_long(
            argc,
            argv,
            b"efmnqsvz\0".as_ptr() as *const ::core::ffi::c_char,
        ...
        match optc {
            ...
            -131 => {
                version_etc(
                    ...
                    Version,
                    proper_name_lite(
                        b"Dmitry V. Levin\0".as_ptr() as *const ::core::ffi::c_char,
                        b"Dmitry V. Levin\0".as_ptr() as *const ::core::ffi::c_char,
                    ),
    ...
    if argc - optind > 1 as ::core::ffi::c_int {
        if no_newline {
            if 0 != 0 {
                error(
                    ...
                    dcgettext(
                        ::core::ptr::null::<::core::ffi::c_char>(),
                        b"ignoring --no-newline with multiple arguments\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        5 as ::core::ffi::c_int,
                    ),
                );
        ...
        no_newline = r#false != 0;
    }
    if !getenv(b"POSIXLY_CORRECT\0".as_ptr() as *const ::core::ffi::c_char).is_null() {
        verbose = r#true != 0;
    }
    while optind < argc {
        let mut fname: *const ::core::ffi::c_char = *argv.offset(optind as isize);
        let mut value: *mut ::core::ffi::c_char = if can_mode != -1 as ::core::ffi::c_int {
            canonicalize_filename_mode(fname, canonicalize_mode_t(can_mode as ::core::ffi::c_uint))
        } else {
            areadlink_with_size(fname, 63 as size_t)
        };
        if !value.is_null() {
