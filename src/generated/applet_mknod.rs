...
// Source SHA-256: f32fd1eeef7c57f57f3e7bcc4a266687635cd73f3797c7548f092ba0c2e11c52
...
extern "C" {
    ...
    fn rpl_mknod(file: *const ::core::ffi::c_char, mode: mode_t, dev: dev_t) -> ::core::ffi::c_int;
    fn strcmp(
...
pub const NODEV: dev_t = -1 as ::core::ffi::c_int as dev_t;
...
pub const PROGRAM_NAME: [::core::ffi::c_char; 6] =
    unsafe { ::core::mem::transmute::<[u8; 6], [::core::ffi::c_char; 6]>(*b"mknod\0") };
...
#[no_mangle]
pub unsafe extern "C" fn _usage_mknod(mut status: ::core::ffi::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn single_binary_main_mknod(
    ...
    let mut set_security_context: *mut selabel_handle = ::core::ptr::null_mut::<selabel_handle>();
    ...
    loop {
        optc = getopt_long(
            argc,
            argv,
            b"m:Z\0".as_ptr() as *const ::core::ffi::c_char,
        ...
        match optc {
            ...
            90 => {
                if is_smack_enabled() {
                    scontext = optarg;
                } else if 0 as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
                    if !optarg.is_null() {
                        scontext = optarg;
                    } else {
            ...
            _ => {
                _usage_mknod(EXIT_FAILURE);
            }
        }
    }
    let mut newmode: mode_t = MODE_RW_UGO as mode_t;
    if !specified_mode.is_null() {
        ...
        if newmode & !S_IRWXUGO as mode_t != 0 {
            if 0 != 0 {
                error(
                    1 as ::core::ffi::c_int,
                    0 as ::core::ffi::c_int,
                    dcgettext(
                        ::core::ptr::null::<::core::ffi::c_char>(),
                        b"mode must specify only file permission bits\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        5 as ::core::ffi::c_int,
                    ),
                );
    ...
    let mut expected_operands: ::core::ffi::c_int = if argc <= optind
    ...
    if argc - optind < expected_operands {
        ...
        if expected_operands == 4 as ::core::ffi::c_int && argc - optind == 2 as ::core::ffi::c_int
        {
            fprintf(
                stderr,
                b"%s\n\0".as_ptr() as *const ::core::ffi::c_char,
                dcgettext(
                    ::core::ptr::null::<::core::ffi::c_char>(),
                    b"Special files require major and minor device numbers.\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    LC_MESSAGES,
                ),
            );
    ...
    if expected_operands < argc - optind {
        if 0 != 0 {
            error(
                ...
                quote(*argv.offset((optind + expected_operands) as isize)),
            );
            if 0 as ::core::ffi::c_int != 0 as ::core::ffi::c_int {
                unreachable!();
            } else {
        ...
        if expected_operands == 2 as ::core::ffi::c_int && argc - optind == 4 as ::core::ffi::c_int
        {
            fprintf(
                stderr,
                b"%s\n\0".as_ptr() as *const ::core::ffi::c_char,
                dcgettext(
                    ::core::ptr::null::<::core::ffi::c_char>(),
                    b"Fifos do not have major and minor device numbers.\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    LC_MESSAGES,
                ),
            );
    ...
    's_381: {
        match *(*argv.offset((optind + 1 as ::core::ffi::c_int) as isize)).offset(0isize)
            as ::core::ffi::c_int
        {
            98 => {
                node_type = S_IFBLK as mode_t;
            }
            99 | 117 => {
                node_type = S_IFCHR as mode_t;
            }
            112 => {
                if !set_security_context.is_null() {
                    defaultcon(
                ...
                if mkfifo(*argv.offset(optind as isize), newmode) != 0 as ::core::ffi::c_int {
                    if 0 != 0 {
                        error(
                            1 as ::core::ffi::c_int,
                            *__errno_location(),
            ...
            _ => {
                if 0 != 0 {
                    error(
                        ...
                        dcgettext(
                            ::core::ptr::null::<::core::ffi::c_char>(),
                            b"invalid device type %s\0".as_ptr() as *const ::core::ffi::c_char,
                            5 as ::core::ffi::c_int,
                        ),
        ...
        let mut s_major: *const ::core::ffi::c_char =
        ...
        .0 != strtol_error::LONGINT_OK.0
            || i_major != i_major as ::core::ffi::c_uint as uintmax_t
        {
            if 0 != 0 {
                error(
                    1 as ::core::ffi::c_int,
                    ...
                    dcgettext(
                        ::core::ptr::null::<::core::ffi::c_char>(),
                        b"invalid major device number %s\0".as_ptr() as *const ::core::ffi::c_char,
                        5 as ::core::ffi::c_int,
                    ),
                    quote(s_major),
                );
                ...
                ({
                    ...
                    error(
                        ...
                        dcgettext(
                            ::core::ptr::null::<::core::ffi::c_char>(),
                            b"invalid major device number %s\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            5 as ::core::ffi::c_int,
                        ),
                        quote(s_major),
        ...
        let mut s_minor: *const ::core::ffi::c_char =
            *argv.offset((optind + 3 as ::core::ffi::c_int) as isize);
        ...
        .0 != strtol_error::LONGINT_OK.0
            || i_minor != i_minor as ::core::ffi::c_uint as uintmax_t
        {
            if 0 != 0 {
                error(
                    1 as ::core::ffi::c_int,
                    ...
                    dcgettext(
                        ::core::ptr::null::<::core::ffi::c_char>(),
                        b"invalid minor device number %s\0".as_ptr() as *const ::core::ffi::c_char,
                        5 as ::core::ffi::c_int,
                    ),
                    quote(s_minor),
                );
                ...
                ({
                    ...
                    error(
                        ...
                        dcgettext(
                            ::core::ptr::null::<::core::ffi::c_char>(),
                            b"invalid minor device number %s\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            5 as ::core::ffi::c_int,
                        ),
                        quote(s_minor),
        ...
        let mut device: dev_t = gnu_dev_makedev(
            i_major as ::core::ffi::c_uint,
            i_minor as ::core::ffi::c_uint,
        );
        if device == NODEV {
            if 0 != 0 {
                error(
                    ...
                    dcgettext(
                        ::core::ptr::null::<::core::ffi::c_char>(),
                        b"invalid device %s %s\0".as_ptr() as *const ::core::ffi::c_char,
                        5 as ::core::ffi::c_int,
                    ),
                    s_major,
                    s_minor,
        ...
        if rpl_mknod(*argv.offset(optind as isize), newmode | node_type, device)
            != 0 as ::core::ffi::c_int
        {
            if 0 != 0 {
                error(
    ...
    if !specified_mode.is_null()
        && lchmod(*argv.offset(optind as isize), newmode) != 0 as ::core::ffi::c_int
    {
        if 0 != 0 {
            error(
                1 as ::core::ffi::c_int,
                *__errno_location(),
                dcgettext(
                    ::core::ptr::null::<::core::ffi::c_char>(),
                    b"cannot set permissions of %s\0".as_ptr() as *const ::core::ffi::c_char,
                    5 as ::core::ffi::c_int,
                ),
                quotearg_style(
