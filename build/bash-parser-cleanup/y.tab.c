            ...
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep)
{
  ...
  switch (yykind) {
    ...
    case YYSYMBOL_REDIR_WORD:
      ...
      break;
    case YYSYMBOL_command:
    case YYSYMBOL_pipeline:
    case YYSYMBOL_pipeline_command:
    case YYSYMBOL_list0:
    case YYSYMBOL_list1:
    case YYSYMBOL_compound_list:
    case YYSYMBOL_simple_list:
    case YYSYMBOL_simple_list1:
    case YYSYMBOL_simple_command:
    case YYSYMBOL_shell_command:
    case YYSYMBOL_for_command:
    case YYSYMBOL_select_command:
    case YYSYMBOL_case_command:
    case YYSYMBOL_group_command:
    case YYSYMBOL_arith_command:
    case YYSYMBOL_cond_command:
    case YYSYMBOL_arith_for_command:
    case YYSYMBOL_coproc:
    case YYSYMBOL_comsub:
    case YYSYMBOL_funsub:
    case YYSYMBOL_function_def:
    case YYSYMBOL_function_body:
    case YYSYMBOL_if_command:
    case YYSYMBOL_elif_clause:
    case YYSYMBOL_subshell:
      dispose_command (yyvaluep->command);
      break;
    default: break;
  }
  YY_IGNORE_MAYBE_UNINITIALIZED_END
