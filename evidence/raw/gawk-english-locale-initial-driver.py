...
name='en_US.UTF-8';stage=ROOT/'build/gawk-english-locale-stage';stage.mkdir(exist_ok=True)
runtime=ROOT/'build/gawk-english-locales';runtime.mkdir(exist_ok=True)
...
log=ROOT/'evidence/raw/gawk-english-locale-build.log'
